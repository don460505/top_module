...
class CustomWidgets{
  ...
  static Widget getRoundedRaisedButton(BuildContext context, String text,
    ...
    return RaisedButton(
      onPressed: onPressed,
      child: CustomWidgets.getText(text,textColor: textColor,fontSize: 16.0,fontWeight: fontWeight),
    ...
    return Column(
      ...
      children:[
        Padding(
          ...
          child: Text(labelText,style: TextStyle(color: Colors.black,fontWeight: FontWeight.w500),),
        ),
        Theme(
